...
def is_constant_key(key):
    for lst in [CONST_TARGETS, BETA_TARGETS, AGE_TARGET, ETHNICITY, EXPRESSIONS, EYEBROWS, EYE_COLORS, SKINS, COMMUNITY_SKINS, SPECIAL_SKINS, COMMUNITY_SPECIAL_SKINS,
                EYELASHES, EYES, TONGUES, TEETH, FACE_TARGETS]:
        if key in lst:
            return True
    return False
